...
\def\logo{\linebreak \includegraphics[height=2.5em]{src/logo.png}} % Path to logo
\def\signatureimage{\vspace*{1.5em}\includegraphics[height=3.5em]{src/signature.png}}% Path to signature image
...
\def\letterheadpath{src/noletterhead.png}  % Default to transparent
\ifthenelse{\equal{\useletterhead}{yes}}{
  \def\letterheadpath{src/letterhead.png}
}{}
\fancyhead[C]{\includegraphics[height=5.0em,width=\textwidth,keepaspectratio]{\letterheadpath}}  % Update here; applies to current/next pages
